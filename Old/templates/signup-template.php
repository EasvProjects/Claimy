<?php include 'inc/signup-header.php'; ?>
                                ...
                                <div class="col-lg-5 login-box-left d-lg-flex bg-grd ">
                                    <div class="align-self-center d-lg-flex text-center text-lg-left justify-content-lg-between d-lg-block text-white">
                                        <div class="form-group pl-0 pl-lg-5">
                                            ...
                                            <h2 class="font-bold">Claimy</h2>
                                            <p><small>-The preferred claim company</small>
                                            <p/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-7 d-flex">
                                    <form id="contact-form" method="post" action="../site/controllers/signup-controller.php" role="form"
                                    <div class="form-row login-form align-self-center">
                                        ...
                                        <div class="col-12 text-lg-center">
                                            <button type="submit" class="btn btn-primary btn-grd mt-3 w-100 border-0">
                                                Sign Up
                                            </button>
                                        </div>
      ...
      c-2.197-0.011-4.406-0.022-6.604-0.044c-0.012-2.198-0.033-4.407-0.045-6.604C83.475,48.668,81.288,48.668,79.102,48.668z"/>
        ...
        C79.057,53.075,79.079,50.866,79.102,48.668z"/>
                                        ...
                                        <div class="w-100 text-center">
                                            <p class=" text-muted mb-0"><small>Already having an account with
                                                    claimy?</small><a href="../site/controllers/signin-controller.php"
                                                                      class="btn-link ml-2">Login</a></p>
...
<?php include 'inc/signup-footer.php'; ?>