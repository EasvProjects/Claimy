<head>
    ...
    <link href="../../../dashboard/view/assets/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
    <link href="../../../dashboard/view/assets/css/gijgo.css" type="text/css" rel="stylesheet" />
    <link href="../../../dashboard/view/assets/css/dataTables.bootstrap4.min.css" type="text/css" rel="stylesheet" />
    <link href="../../../dashboard/view/assets/css/buttons.bootstrap4.min.css" type="text/css" rel="stylesheet" />

    <link href="../../../dashboard/view/assets/css/style.css" type="text/css" rel="stylesheet" />
</head>
<body>
...
<header class="bg-grd">
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="../../../dashboard/controllers/index-controller.php">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                <img src="../../../dashboard/view/assets/fonts/icons/menu.svg" width="20">
            </button>

            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item ">
                        <a class="nav-link active" href="../../../dashboard/controllers/index-controller.php">All cases</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="../../../dashboard/controllers/inbox-controller.php">New messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../../dashboard/controllers/company-details.php">Settings</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="../../../dashboard/controllers/myaccount.php">My account</a>
                            <a class="dropdown-item" href="../../../dashboard/controllers/signin-controller.php">Logout</a>
                        </div>
                    </li>
                </ul>
