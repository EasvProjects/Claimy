  ...
  <div class="card border-0 bg-white form-wizard">
         ...
         <div class="d-block d-lg-none mb-3">
          <div class="nav-item dropdown corner-radius">
            ...
            <div class="dropdown-menu navbar-inner shadow border-0 w-100 py-0" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item ml-2 text-primary"  href="languages-list.php">- Website Languages</a>
          ...
          <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
            ...
            <li><a class="nav-link active"  href="supported-countries-list.php" >Global</a>
              <ul class="list-unstyled ">
                ...
                <li><a class="nav-link text-primary"  href="languages-list.php">- Website Languages</a></li>
              </ul>
            </li>
    ...
    <form id="form1">
     <div class="d-flex align-items-center">
      ...
      <div class="pl-3">
       <img id="img-uploaded" src="assets/images/flag.png" alt="" width="80" />
     </div>
   </div>
 </form>
</div><!------>
...
<div class="form-actions form-group">
  <a href="languages-list.php" class="btn btn-alt">Cancel</a>
  <a href="languages-list.php" class="btn btn-grd">Add</a>
</div>
</div>
</div>
</div>
