                ...
                <div class="row">
                    ...
                    <div class="col col-sidebar">
                        <div class="d-block d-lg-none mb-3">
                            <div class="nav-item dropdown corner-radius">
                                ...
                                <div class="dropdown-menu navbar-inner shadow border-0 w-100 py-0"
                                    ...
                                    <a class="dropdown-item active" href="../../dashboard/controllers/third-party-controller.php">Third Party</a>
                        ...
                        <div class="d-none d-lg-block">
                            ...
                            <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
                                ...
                                <li><a class="nav-link active" href="../../dashboard/controllers/third-party-controller.php">Third Party</a></li>
                    ...
                    <div class="col col-content">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="" class="form-control" value="1234567">
                            </div>
                        </div><!------>
                        <div class="form-group">
                            <label class=" col-form-label">Facebook key id</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="12345678">
                            </div>
                        </div><!------>
                        ...
                        <div class="form-group">
                            <label class=" col-form-label">Google key id</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="12345678">
                            </div>
                        </div><!------>
                        <div class="divider"></div>
                        <div class="form-group">
                            <label class=" col-form-label">Trust pilot app id</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="1234567">
                            </div>
                        </div><!------>
                        <div class="form-group">
                            <label class=" col-form-label">Trust pilot key</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="12345678">
                            </div>
                        </div><!------>
                        <div class="divider"></div>
                        <div class="form-group">
                            <label class=" col-form-label">Chotbot app id</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="1234567">
                            </div>
                        </div><!------>
                        <div class="form-group">
                            <label class=" col-form-label">Chotbot key</label>
                            <div class="">
                                <input type="text" name="" class="form-control" value="12345678">
                            </div>
                        </div><!------>
