          ...
          <div class="col col-sidebar">
              ...
              <div class="d-none d-lg-block">
                  ...
                  <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
                      ...
                      <li><a class="nav-link active" href="../../dashboard/controllers/about-us-controller.php">About us</a>
                          <ul class="list-unstyled ">
                              <li><a class="nav-link text-primary" href="../../dashboard/controllers/team-controller.php">- Team</a></li>
          ...
          <li>
            <div class="card shadow team-card text-center">
              <div class="u-lg-avatar mb-4 text-center">
                <img class="img-fluid rounded-circle avatar-img" src="../../dashboard/view/assets/images/avatar.png" alt="avatar" width="80">
              </div>
