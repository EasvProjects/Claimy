    ...
    <div class="container">
     ...
     <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item ">
          <a class="nav-link active" href="company-details.php">Settings</a>
        </li>
...
<section class="main-section section-padding">
  ...
  <div class="card border-0 bg-white form-wizard">
    <div class="card-body">
      <div class="row">
       <!----page sidebar menu--->
            ...
            <div class="nav-item dropdown corner-radius">
              ...
              <div class="dropdown-menu navbar-inner shadow border-0 w-100 py-0" aria-labelledby="sidenav">
                ...
                <a class="dropdown-item active"  href="teams.php" >About us</a>
                <a class="dropdown-item ml-2 text-primary"  href="teams.php" >- Team</a>
          ...
          <div class="d-none d-lg-block" >
            ...
            <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
              ...
              <li><a class="nav-link active"  href="teams.php" >About us</a>
                  <ul class="list-unstyled ">
                    <li><a class="nav-link text-primary"  href="teams.php">- Team</a></li>
       ...
       <div class="col col-content">
        ...
        <ul class="row list-unstyled team-list">
            <!---team cards list--->
          <li>
            <div class="card shadow team-card text-center">
              <div class="u-lg-avatar mb-4 text-center">
                <img class="img-fluid rounded-circle avatar-img" src="assets/images/avatar.png" alt="avatar" width="80">
              </div>
              <h4 class="avatar-name">Sgurd CEO bergstrom</h4>
              <small class="d-block text-secondary text-uppercase mb-2">Buisness development</small>
              <div class="action-btn">
                <a href="#" class="team-card-edit-btn">
              ...
              <a href="#" class="team-card-trash-btn">
                <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     ...
     <!-----Add more--->
      <li>
        <div class="card shadow add-team-btn add-team-card text-center p-3 align-items-center flex-row text-center justify-content-center"  data-toggle="modal" data-target="#team-modal">
          <a class="align-self-center " >
          <div class=" mb-4 text-center">
            <svg version="1.1" width="30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 42 42" style="enable-background:new 0 0 42 42;" xml:space="preserve">

            <linearGradient id="theme-grd-add" gradientUnits="userSpaceOnUse" x1="0" y1="258" x2="512" y2="258" gradientTransform="matrix(1 0 0 -1 0 514)">
                  <stop offset="0" style="stop-color:#1488cc"></stop>
                  <stop offset="0.293" style="stop-color:#0d65bf"></stop>
                  <stop offset="0.554" style="stop-color:#1c4cb9"></stop>
                  <stop offset="0.796" style="stop-color:#1c4cb9"></stop>
            ...
            <polygon style="fill:url(#theme-grd-add);" points="42,19 23,19 23,0 19,0 19,19 0,19 0,23 19,23 19,42 23,42 23,23 42,23 "/>
          </svg>
        </div>
        <h4 class="">Add More</h4>
      </a>
      </div>
    </li>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" placeholder="Sgurd Bergstrom">
          </div>
           <div class="form-group">
