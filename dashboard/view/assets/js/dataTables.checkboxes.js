            ...
            if (ctx.aoColumns[i].checkboxes){
               ...
               if(ctx.aoColumns[i].mRender === null){
                  colOptions['render'] = function(){
                     ...
                     // return '<label class="form-checkbox-label mb-0">'
                     //                +'<input class="form-checkbox-field  dt-checkboxes" type="checkbox" />'
                     //               + '<i class="form-checkbox-button"></i>'
                     //               + '<span class="v-hidden d-inline-block"></span>'
                     //               + '</label>'
   ...
   */
   Checkboxes.defaults = {
      ...
      */
      ...
      // selectAllRender: '<label class="form-checkbox-label mb-0">' 
