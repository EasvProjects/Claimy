                ...
                <div class="col col-sidebar">
                    <div class="d-block d-lg-none mb-3">
                        <div class="nav-item dropdown corner-radius">
                            ...
                            <div class="dropdown-menu navbar-inner shadow border-0 w-100 py-0"
                                ...
                                <a class="dropdown-item active" href="../../dashboard/controllers/employees-list-controller.php">GDPR</a>
                    ...
                    <div class="d-none d-lg-block">
                        ...
                        <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
                            ...
                            <li><a class="nav-link active" href="../../dashboard/controllers/employees-list-controller.php">GDPR</a></li>
                            ...
                            <li><a class="nav-link" href="../../dashboard/controllers/employees-controller.php">Employees</a></li>
