    ...
    <div class="container">
     ...
     <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php">Global</a>
        </li>
        <li class="nav-item">
        ...
        <!----page sidebar menu--->
            ...
            <div class="nav-item dropdown corner-radius">
              ...
              <div class="dropdown-menu navbar-inner shadow border-0 w-100 py-0" aria-labelledby="sidenav">
                ...
                <a class="dropdown-item active"  href="employees-list.php" >Employees</a>
          ...
          <div class="d-none d-lg-block" >
            ...
            <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
              ...
              <li><a class="nav-link active"  href="employees-list.php" >Employees</a></li>
       ...
       <div class="col col-content">
        <div>
          <div class="table-header text-lg-right mb-3">
           <a href="employees.php" class="btn btn-grd">Add</a>
          </div>
