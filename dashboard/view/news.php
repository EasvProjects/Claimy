    ...
    <div class="row">
        ...
        <div class="col col-sidebar">
            ...
            <div class="d-none d-lg-block">
                ...
                <ul class="list-unstyled nav flex-column nav-pills navbar-inner ">
                    ...
                    <li><a class="nav-link active" href="../../dashboard/controllers/news-list-controller.php">News</a></li>
       ...
       <div class="col col-content">
        ...
        <div class="form-group">
          ...
          <div class="">
           <input type="text" name="" id="news_date" class="form-control" value="" placeholder="DD-MM-YYYY">
         </div>
       </div><!------>
        <div class="form-group">
        ...
        <label class=" col-form-label">Picture</label>
          <div class="">
           <input type="file" name="" id="" class="form-control" value="" placeholder="">
         </div>
                </div>
       <div class="form-group">
      ...
      <div class="form-actions form-group">
        <a href="../../dashboard/controllers/news-list-controller.php" class="btn btn-alt">Cancel</a>
