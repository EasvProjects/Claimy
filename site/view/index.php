  ...
  <div class="home">
    ...
    <header>
      <div class="container">
       ...
       <a href="signin.php" class="btn btn-primary btn-login  d-block d-lg-none ml-auto mr-3">Login</a>
    ...
    <div class="banner-content text-white text-center text-lg-left">
      <div class="col-12 col-lg-9">
        <div class="banner-caption">
          ...
          <a href="claim.php" class="btn btn-primary btn-lg">Start your claim</a>
        </div>
      </div>
    </div>
  </div>
