                            ...
                            <div class="col-lg-7 d-flex">
                                <div class="form-row login-form align-self-center">
                                    ...
                                    <div class="col-12 d-md-flex justify-content-between">
                                        ...
                                        <p class="mb-0"><a href="#" class="text-theme a-link form-group">Forgot
                                                Password?</a></p>
                                    </div>
                                    <div class="col-12 text-lg-center">
                                        <button type="submit" name="SubmitButton1" class="btn btn-primary btn-grd mt-3 w-100 border-0"  onclick="clientLoginAjax()">Log
                                            In
                                        </button>
                                    </div>
      ...
      c-2.197-0.011-4.406-0.022-6.604-0.044c-0.012-2.198-0.033-4.407-0.045-6.604C83.475,48.668,81.288,48.668,79.102,48.668z"/>
        ...
        C79.057,53.075,79.079,50.866,79.102,48.668z"/>
                                    ...
                                    <div class="w-100 text-center">
                                        <p class=" text-muted mb-0"><small>New at claimy?</small><a
                                                    href="../controllers/signup-controller.php"
                                                    class="btn-link ml-2">Sign
                                                Up</a></p>
