          ...
          <ul class="navbar-nav ml-auto">
           ...
           <!--  <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="my-cases.html">My cases</a>
                <a class="dropdown-item" href="user-setting.html">User setting</a>
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <small class="text-secondary">
                ...
                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" height="16px" width="16px">
                <linearGradient id="theme-grd" gradientUnits="userSpaceOnUse" x1="0" y1="258" x2="512" y2="258" gradientTransform="matrix(1 0 0 -1 0 514)">
                  ...
                  <stop  offset="0.293" style="stop-color:#0d65bf"/>
                  <stop  offset="0.554" style="stop-color:#1c4cb9"/>
                  <stop  offset="0.796" style="stop-color:#1c4cb9"/>
                  <stop  offset="1" style="stop-color:#2b32b2"/>
                </linearGradient>
                <path style="fill:url(#theme-grd);" d="M472,332V120c0-22.056-17.944-40-40-40h-26v20c0,11.046-8.954,20-20,20s-20-8.954-20-20V80
              ...
              </svg>&nbsp;&nbsp;20-11-2019</small>
              <p class="media-description"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
            </div>
            <div>
              <a href="../../site/controllers/news-detail.php" class="btn btn-grd ml-md-3">Read More</a>
            </div>
          </div>
        </div>
        <!---media card end--->
        ...
        <div class="card border-0 media-card bg-white">
          <div class="media">
            ...
            <div class="media-body">
              ...
              <p class="media-description"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
