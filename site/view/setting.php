        ...
        <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
            <a class="nav-link" href="n../../site/controllers/news-controller.php">News</a>
          </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="../../site/controllers/signin-controller.php">Logout</a>
              </div>
            </li>
          </ul>
...
<div class="modal fade" id="deleteacc" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    Are you sure you want to detete account?
      </div>
