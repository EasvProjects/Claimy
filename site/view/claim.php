...
<div class="divider"></div>
                 <button class="btn btn-alt pull-right" type="submit">Back</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    Your claim is now received.You will receive email as soon it is under process.
      ...
      <div class="modal-footer">
        <a href="myaccount.php" class="btn btn-alt">Go to my account</a>
        <a href="index.php" class="btn btn-grd">Back to main page</a>
