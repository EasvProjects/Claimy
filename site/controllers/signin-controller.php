...
$g_client->setRedirectUri("http://claimy-dev.dk/site/controllers/myaccount-controller.php");
...
if(empty($access_token)) {
    ...
    $facebook_auth_url = $fb->getRedirectLoginHelper()->getLoginUrl("http://claimy-dev.dk/site/controller/myaccount-controller.php/");
